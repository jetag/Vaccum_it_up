...
echo "Hi, $USER! Let's clean up your system!" 
echo "Warning !!! This script will remove old versions of Linux Kernel, apt cache, snap packages, ALL DOCKER CONTAINER and logs."  
